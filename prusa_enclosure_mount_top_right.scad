        ...
        union() {
            for (yo = [-20, 20]) {
                ...
                difference() {
                    ...
                    // Through screw hole
                    translate([120, 0, -1])
                    cylinder(h=22, d=3.2, $fn=50);
                    
                    // Hex nut / screw head cutout 
                    translate([120, 0, 20 - (2.6 / 2)])
            ...
            // Spoolmount support ring
            {
                ...
                difference() {
                    union() {
                        // Top core
                        translate([0, 0, 2.5])
                        cylinder(h=17.5, r=42, $fn=200);

                        // Bottom core
                        cylinder(h=20, r=40.25, $fn=200);
                    }

                    // Center through cutout
                    translate([0, 0, -1])
                    cylinder(h=22, r=25, $fn=200);
